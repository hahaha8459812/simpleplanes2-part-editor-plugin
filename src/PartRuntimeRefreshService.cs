...
namespace SimplePlanes2PartEditor
{
    internal sealed class PartRuntimeRefreshService
    {
        ...
        public bool TryRefreshAfterApply(InspectableMember member)
        {
            ...
            refreshed |= TryNotifyModifierPropertyChanged(target, member.Name, member.Value);
        ...
        private static bool TryNotifyModifierPropertyChanged(object target, string propertyName, string value)
        {
            MethodInfo method;
